...
-(void)up_view
{
    if (_screenshotsSideButton == nil) {
        _screenshotsSideButton = [MapButton buttonWithType:(UIButtonTypeCustom)];
        _screenshotsSideButton.frame = CGRectMake(view_width + 10, view_height / 2 - 22, 110, 50);
        _screenshotsSideButton.backgroundColor = color_gray;
        
        
        [_screenshotsSideButton setImage:[UIImage imageNamed:@"map"] forState:(UIControlStateNormal)];
        [_screenshotsSideButton setTitle:@"编辑分享" forState:(UIControlStateNormal)];
...
- (void)userDidTakeScreenshot:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:time1 animations:^{
        ...
        _screenshotsSideButton.transform=CGAffineTransformMakeTranslation( -120, 0);
    ...
    _screenshotsSideButton.StickersImg.image = image_;
...
-(void)payButtonAction:(MapButton *)button
{
    _screenshotsSideButton.transform=CGAffineTransformMakeTranslation(120, 0);
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"presentMapAdviceViewController" object:nil userInfo:nil];
}
