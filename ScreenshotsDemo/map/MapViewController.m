...
@property(nonatomic,strong) MapView *myView;
...
{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(mapViewAction) name:@"presentMapAdviceViewController" object:nil];
    
    _myView = [[MapView alloc]initWithFrame:self.view.frame];
    [self.view addSubview:_myView];
}

-(void)mapViewAction
{
    [self.navigationController pushViewController:[[MapStickersViewController alloc]init] animated:YES];
}
